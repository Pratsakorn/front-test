...
function Home() {
  ...
  return (
    <div className="h-screen w-full bg-[url('/home.svg')] bg-cover bg-center bg-fixed flex flex-col justify-center items-center">
      <Navbar />
      <div className='flex flex-col justify-center items-center text-white w-[578px] h-[312px]'>
        ...
        hover:translate-y-1 hover:scale-110 hover:bg-[#25CDD9] hover:shadow-[0px_0px_10px_#25CDD9] hover:border-transparent'>
          <img src='right_i.svg' className='lg:rotate-0 sm:rotate-90 transition duration-300'/>
        </button>
        </Link>
      </div>
    </div>
